...
wifiscope 用 OpenSpec 形态的 SDD 开发。每一个会改动行为的能力都
对应 `openspec/specs/<name>/spec.md` 下的一份权威契约。

- **完整流程**：[`docs/zh/workflow.md`](workflow.md)（[English](../workflow.md)）
- **Agent 规则**：[`openspec/AGENTS.md`](../../openspec/AGENTS.md)
- **测试方案**：[`tests/TESTING.md`](../../tests/TESTING.md)（[中文](TESTING.md)）
- **PR 模板**：[`.github/pull_request_template.md`](../../.github/pull_request_template.md)
- **CI 强制项**：pytest 矩阵 · 回归 · `openspec --strict` 校验
