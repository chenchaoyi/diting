...
### ADDED Requirement: AP attribution SHALL try four resolution paths in order
...
### ADDED Requirement: aps.yaml SHALL be optional; the tool SHALL run without it
...
### ADDED Requirement: Inventory SHALL ALSO carry the Wi-Fi-OUI-vendor map
...
### ADDED Requirement: Cluster labels SHALL be stable across sessions for the same physical AP
...
### ADDED Requirement: BSSID format normalisation SHALL be lowercase colon-separated
