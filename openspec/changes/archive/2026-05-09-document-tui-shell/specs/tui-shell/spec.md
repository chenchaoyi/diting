...
### ADDED Requirement: The TUI SHALL have exactly four stacked panels in a fixed order
...
### ADDED Requirement: Diagnostics panel content SHALL follow the active view
...
### ADDED Requirement: Modal screens SHALL push onto a stack and Esc / their own letter SHALL close
...
### ADDED Requirement: The footer SHALL be a single GroupedFooter with three semantic groups
...
### ADDED Requirement: Hidden bindings SHALL exist for power-user navigation
...
### ADDED Requirement: The header SHALL show title + clock; the subtitle SHALL describe the live state
