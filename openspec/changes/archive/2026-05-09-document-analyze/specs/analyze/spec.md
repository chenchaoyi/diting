...
### ADDED Requirement: Analyze SHALL be pure rules, no LLM, no network
...
### ADDED Requirement: The report SHALL open with span / counts / connection timeline
...
### ADDED Requirement: Insights SHALL be produced by named heuristics with explicit trigger conditions
...
### ADDED Requirement: Loss-percent rendering SHALL handle both 0..1 fractions and 0..100 percent
...
### ADDED Requirement: Duration formatting SHALL use units honestly — `1s`, never `1 min`
...
### ADDED Requirement: The "what to do next" section SHALL exist when ANY insight fires
