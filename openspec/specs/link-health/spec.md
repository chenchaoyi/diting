...
### Requirement: Probes SHALL hit the gateway via ICMP and the WAN via TCP/53
...
### Requirement: Aggregates SHALL be computed over a rolling 60 s window
...
### Requirement: Network change SHALL force a complete probe reset
...
### Requirement: Loss bursts and latency spikes SHALL fire as discrete events
...
### Requirement: WAN-only outages SHALL be distinguishable from full link loss
